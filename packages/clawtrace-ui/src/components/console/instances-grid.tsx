    ...
    <div className={styles.root}>
      ...
      {loading ? (
        ...
        <div className={styles.emptyState}>
          ...
          <h3 className={styles.emptyTitle}>No OpenClaw connections yet</h3>
          <p className={styles.emptyBody}>
            Connect your first OpenClaw agent to start capturing trajectories, tracking costs, and debugging runs.
          </p>
          <a href="/connect" className={styles.emptyBtn}>
