      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerRight}>
          ...
          <a href="https://github.com/epsilla-cloud/clawtrace" target="_blank" rel="noopener" className={styles.githubBadge} aria-label="Star on GitHub">
            <img src="https://img.shields.io/github/stars/epsilla-cloud/clawtrace?style=social" alt="GitHub stars" height="20" />
          </a>
          <span className={styles.desktopOnly}><UserButton /></span>
        </div>
