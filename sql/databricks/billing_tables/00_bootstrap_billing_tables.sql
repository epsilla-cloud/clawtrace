...
-- ============================================================================
-- Creates tables for credit usage aggregation from the billing audit logs
-- stored in Azure Blob Storage (clawtrace-billing container).
-- ============================================================================

-- 1. Checkpoint table for incremental processing
CREATE TABLE IF NOT EXISTS billing_checkpoint (
...
-- Seed checkpoint
INSERT INTO billing_checkpoint
SELECT 'usage_ingest', TIMESTAMP '1970-01-01 00:00:00'
WHERE NOT EXISTS (SELECT 1 FROM billing_checkpoint WHERE pipeline = 'usage_ingest');
...
CREATE TABLE IF NOT EXISTS billing_usage_hourly (
    user_id         STRING NOT NULL,
